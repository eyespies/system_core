...
describe 'system_core::repos' do
  ol7_repos = %w(ol7_base_latest
                 ...
                 ol7_optional_latest
                 ol7_epel_latest)
  ol7_disabled_repos = %w(ol7_uek4_latest
                          ol7_uek5_latest
  ...
  ol8_disabled_repos = %w(ol8_kvm_appstream_latest
      ...
      context "On #{platform} #{version} setup YUM repositories and remove MySQL if is not updated" do
        ...
        if platform == 'oracle'
          if major_version == '7'
            ...
            ol7_disabled_repos.each do |repo|
              it "should NOT enable the #{repo} repo for Oracle Linux 7" do
            ...
            ol8_disabled_repos.each do |repo|
              it "should NOT enable the #{repo} repo for Oracle Linux 8" do
                expect(chef_run).to_not create_yum_repository(repo)
              end
            end
          else
